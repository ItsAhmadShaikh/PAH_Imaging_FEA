...
addpath('result_geo2Y325');
addpath('/Users/kristengarcia/Documents/Cobiveco_RatAddition/examples/result_geo2Y325/')

%% Define paths

sourcePrefix = '/Users/kristengarcia/Documents/Cobiveco_RatAddition/examples/result_geo2Y325/';
outputPrefix = 'result_parcellationY325/';
...
%% Count unique parcellations
uniqueRegions = unique(source.pointData.parcellation);
numRegions = numel(uniqueRegions);
fprintf('Number of parcellations: %d\n', numRegions);
disp('Region IDs:');
disp(uniqueRegions');
%% Export result
